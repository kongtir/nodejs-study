...
exports.roomlist=function (req, res) {//
    res.render('admin/roomlist', {  roomlist:"active_tab", title: '聊天室管理',admin:req.session.username, layout:'layoutadmin',f1:"active_tab"});
};
//后台管理-添加聊天室
exports.addroom=function (req, res) {//
    ...
    if(req.files.length>0){//转储文件
        ...
        if(fs1==undefined)  rModel.photoUrl =targetPath ;
